...
const moduleFiles = [
  "public/js/shape-recognition.mjs",
  "public/js/clear-blue-ui.js",
  "public/js/text-count.mjs",
...
const mediaFileContracts = [
  ...
  [studentHtmlSource, 'accept="image/*,video/mp4,video/webm,video/ogg,video/quicktime,audio/*,.mp3,.m4a,.wav,.ogg,.aac,.flac"'],
  ...
  [whiteboardSource, 'kind: isAudio ? "audio" : "video"'],
...
const distributionContracts = [
  ...
  [copyBoardFunctionSource, '["image", "video", "audio"].includes'],
